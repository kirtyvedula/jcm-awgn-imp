...
% =================================================
Nbits = 5*11E5; % total number of bits
EbN0_dB_test = 3;
% n = 7;
% k = 4;
...
% BLER curve
figure(1)
plot(1:N,BLER,'b.',1:N,HBLER,'.r',[1 N],[mean(sdec_BLER) mean(sdec_BLER)],'r',[1 N],[mean(sdec_ae_BLER) mean(sdec_ae_BLER)],'b','Linewidth',2,'Markersize',3);
grid on;
xlabel('i');
ylabel('BLER')
xlim([0 N])
legend('AE-BLER','HBLER','overall HBLER','overall AE BLER','Location','nw');
% saveas(gcf,strcat('figs/H',num2str(n),num2str(k),'_BLER_curve'),'eps');
figure(2)
plot(1:N,BLER_sorted,'b.',1:N,HBLER_sorted,'.r',[1 N],[mean(sdec_BLER) mean(sdec_BLER)],'r',[1 N],[mean(sdec_ae_BLER) mean(sdec_ae_BLER)],'b','Linewidth',2,'Markersize',3);
grid on;
xlabel('i');
ylabel('BLER')
xlim([0 N])
